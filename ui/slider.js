...
export function Slider(
    ...
    this.elems = {
        ...
        lower: {
            ...
            left: {
                ...
                time: Utils.createElem("div", ["slider-control-item", "slider-time"], {}, "--/--")
            },
    ...
    this.elems.base = Utils.createElem("div", ["slider", "noselect"], {}, "", [
    ...
    this.setProgress = (progress) => {
        ...
        let [total_fmt, blocks] = Utils.formatTime(((this.range[1] - this.range[0]) / speed), false);
        let [elapsed_fmt, blocks2] = Utils.formatTime(((this.val - this.range[0]) / speed), false, blocks);

        this.elems.lower.left.time.innerHTML = elapsed_fmt + " / " + total_fmt;
